...
body {font-family: 'Exo', sans-serif;font-size:13px;line-height:auto;color:#2C3E4F;padding:0;margin:0;}
.badge-link {display: block;}
#profile-header {background-color: #fff;position:relative;width: 100%;border-radius:2px;height:110px;width:100%;}
